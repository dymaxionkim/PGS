...
| Zp2 | Stage-2 planet gear teeth number [ea], > 0 (3K-Wolfrom only); stage-2 planets are placed on the stage-1 carrier radius and ring2 adapts to mesh with them |
| Zr1 | Stage-1 ring gear teeth number [ea], > 0 (Simple only); the Simple Type inputs this instead of Zp2 |
